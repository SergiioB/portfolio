...
export const dictionary: Record<string, Record<Lang, string>> = {
  ...
  'about.coverLetterDesc': { en: 'General-purpose cover letter summarizing experience, automation focus, and delivery outcomes.', es: 'Carta de presentación general resumiendo experiencia, enfoque en automatización y resultados de entrega.' },
