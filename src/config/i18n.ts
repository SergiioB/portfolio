...
export const dictionary: Record<string, Record<Lang, string>> = {
  ...
  "site.tagline": {
    en: "Infrastructure delivery, automation, and applied enterprise AI",
    es: "Infraestructura, automatización e IA empresarial aplicada",
  },
  "site.description": {
    en: "Case-study driven portfolio focused on Linux platform engineering, virtualization, Ansible automation, RHEL lifecycle modernization, and practical AI integration in enterprise environments.",
  ...
  "exec.status": { en: "Madrid · systems online", es: "Madrid · sistemas online" },
  "exec.command": { en: "Navigate", es: "Navegar" },
  ...
  "exec.heroKicker": {
    en: "Systems engineering · local AI · product",
    es: "Ingeniería de sistemas · IA local · producto",
  },
  "exec.heroTitle": {
    en: "I build systems that stay understandable under pressure.",
    es: "Construyo sistemas que siguen siendo comprensibles bajo presión.",
  },
  "exec.heroLede": {
    ...
    es: "Operaciones Linux empresariales, experimentos de inferencia local y apps Android en producción, documentados sin ocultar los trade-offs.",
  },
  "exec.exploreNotes": { en: "Explore field notes", es: "Explorar notas técnicas" },
  "exec.viewProfile": { en: "Profile + CV", es: "Perfil + CV" },
  "exec.proofEnterprise": { en: "Enterprise operations", es: "Operaciones empresariales" },
  "exec.proofLocal": { en: "Local AI lab", es: "Laboratorio de IA local" },
  "exec.proofProducts": { en: "Shipped software", es: "Software publicado" },
  "exec.mapLive": { en: "interactive", es: "interactivo" },
  "exec.mapHint": {
    en: "Select a node to inspect the system",
    es: "Selecciona un nodo para inspeccionar el sistema",
  },
  "exec.productionApps": { en: "Production Apps", es: "Apps en producción" },
  "exec.appsHeading": {
    en: "Useful software, not AI wrappers.",
    es: "Software útil, no simples wrappers de IA.",
  },
  "exec.appsIntro": {
    en: "Two privacy-minded Android products built around local-first value and resilient cloud boundaries.",
    es: "Dos productos Android orientados a la privacidad, construidos sobre valor local-first y límites cloud resilientes.",
  },
  ...
  "exec.intelliflowDesc": {
    en: "Privacy-first personal finance tracker. Offline-first design with best-effort cloud sync, budget projections, and automated insight generation.",
    es: "Gestor de finanzas personales privacy-first. Diseño offline-first con sincronización cloud best-effort, proyecciones de presupuesto e insights automatizados.",
  },
  ...
  "exec.handbookDesc": {
    en: "An engineer's guide to Local AI. Demystifying Transformer architectures, KV cache quantization, modern attention and MoE routing.",
    es: "Una guía de IA local para ingenieros. Arquitecturas Transformer, cuantización de KV cache, atención moderna y enrutamiento MoE sin humo.",
  },
  ...
  "exec.notesHeading": {
    ...
    es: "Medido, fallado, corregido, documentado.",
  },
  ...
  "hero.typewriter": {
    en: "Production ops and platform modernization field notes",
    es: "Notas de campo: operaciones en producción y modernización de plataformas",
  },
  "hero.description": {
    en: "Practical posts organized as case studies with clear situation, issue, solution, usage context, and impact.",
    es: "Posts prácticos en formato caso de estudio: situación, problema, solución, contexto de uso e impacto.",
  },
  ...
  "hero.roleTitle": {
    en: "Linux & Virtualization Engineer",
    es: "Ingeniero Linux y Virtualización",
  },
  "hero.roleCompany": {
    en: "Deutsche Pfandbriefbank AG · Madrid · Hybrid",
    es: "Deutsche Pfandbriefbank AG · Madrid · Híbrido",
  },
  "hero.publishedPosts": { en: "Published posts", es: "Posts publicados" },
  "hero.postsMeta": {
    en: "Case-study driven technical notes",
    es: "Notas técnicas con formato caso práctico",
  },
  "hero.lastUpdate": { en: "Last update", es: "Última actualización" },
  "hero.noPostsYet": { en: "No posts yet", es: "Sin posts aún" },
  "hero.archiveFirst": {
    en: "Archive-first publishing flow",
    es: "Publicación centrada en el archivo",
  },
  ...
  "focus.infraTitle": {
    en: "Infrastructure automation at scale",
    es: "Automatización de infraestructura a escala",
  },
  "focus.infraDesc": {
    en: "Ansible + Git workflows for auditable rollouts, lifecycle changes, and safer operational execution.",
    es: "Flujos Ansible + Git para despliegues auditables, gestión de ciclo de vida y ejecución operativa segura.",
  },
  "focus.rhelTitle": { en: "RHEL modernization", es: "Modernización RHEL" },
  "focus.rhelDesc": {
    en: "RHEL 7/8 to 9 migration planning, Satellite lifecycle control, patch orchestration, and hardening.",
    es: "Migración RHEL 7/8 a 9, gestión Satellite, orquestación de parches y bastionado.",
  },
  ...
  "audience.copy": {
    en: "Recruiter view prioritizes impact, role fit, and business outcomes first. Engineer view enables full live labs, telemetry streams, and command simulations.",
    es: "La vista Recruiter destaca impacto, encaje profesional y resultados de negocio. La vista Ingeniero abre labs en vivo, telemetría y simulación de comandos.",
  },
  ...
  "recruiter.roleFit1": {
    en: "Linux platform administration in enterprise environments",
    es: "Administración de plataformas Linux en entornos corporativos",
  },
  "recruiter.roleFit2": {
    en: "Infrastructure as code with Ansible + Git workflow discipline",
    es: "Infraestructura como código con Ansible y flujos Git",
  },
  "recruiter.roleFit3": {
    en: "Cross-team delivery from design through operational handoff",
    es: "Entrega transversal desde diseño hasta puesta en producción",
  },
  "recruiter.topOutcomes": { en: "Top outcomes", es: "Logros destacados" },
  "recruiter.outcome1": {
    en: "Patch and lifecycle orchestration patterns for safer rollouts",
    es: "Orquestación de parches y ciclo de vida para despliegues seguros",
  },
  "recruiter.outcome2": {
    en: "RHEL modernization playbooks for controlled migrations",
    es: "Playbooks de modernización RHEL para migraciones controladas",
  },
  "recruiter.outcome3": {
    en: "Applied AI pilots documented from prototype to operations",
    es: "Pilotos de IA documentados de prototipo a producción",
  },
  "recruiter.quickActions": { en: "Quick actions", es: "Acceso rápido" },
  "recruiter.openProfile": {
    en: "Open profile and experience summary",
    es: "Ver perfil y experiencia",
  },
  "recruiter.reviewStudies": { en: "Review all case studies", es: "Ver todos los casos prácticos" },
  "recruiter.ctaText": {
    en: "Ready to review full experience and delivery outcomes?",
    es: "¿Quieres ver la experiencia completa y los resultados?",
  },
  ...
  "engineer.teaserText": {
    en: "Recruiter Mode keeps this portfolio concise and impact-first. Switch to Engineer Mode to open live Linux telemetry, command simulation, and network topology labs.",
    es: "El Modo Recruiter mantiene el portfolio conciso y centrado en impacto. Activa el Modo Ingeniero para abrir labs de telemetría Linux, simulación de comandos y topología de red en vivo.",
  },

  /* ── Engineer Lab ── */
  "engineerLab.title": {
    en: "Engineer Lab · Live Linux + AI Simulation",
    es: "Lab de Ingeniería · Simulación Linux + IA en Vivo",
  },
  ...
  /* ── Ops Deck ── */
  "opsDeck.title": {
    en: "Ops Cockpit · top + command sandbox",
    es: "Cockpit Ops · top + sandbox de comandos",
  },
  ...
  "opsDeck.processMeta": {
    en: "click headers to sort · values stream live",
    es: "clic en cabecera para ordenar · datos en tiempo real",
  },
  "opsDeck.sandboxTitle": { en: "Command sandbox", es: "Sandbox de comandos" },
  "opsDeck.sandboxMeta": {
    en: "try: top · journalctl -n 5 · ansible --version · ai.health",
    es: "prueba: top · journalctl -n 5 · ansible --version · ai.health",
  },
  "opsDeck.inputPlaceholder": { en: "Type a command...", es: "Escribe un comando..." },
  "opsDeck.run": { en: "Run", es: "Ejecutar" },
  "opsDeck.helpHint": {
    en: "Try `help` for available commands.",
    es: "Prueba `help` para ver comandos disponibles.",
  },
  ...
  "domains.activeDomains": {
    en: "active domains with published case studies.",
    es: "dominios activos con casos de estudio publicados.",
  },

  /* ── Categories ── */
  "cat.infrastructure": { en: "Infrastructure", es: "Infraestructura" },
  "cat.infrastructure.desc": {
    en: "RHEL lifecycle, automation, virtualization, and production operations.",
    es: "Ciclo de vida RHEL, automatización, virtualización y operaciones en producción.",
  },
  "cat.automation": { en: "Automation", es: "Automatización" },
  "cat.automation.desc": {
    en: "Ansible playbooks, task automation, and configuration management.",
    es: "Playbooks Ansible, automatización de tareas y gestión de configuración.",
  },
  "cat.ai": { en: "AI", es: "IA" },
  "cat.ai.desc": {
  ...
  "cat.cloud.desc": {
    en: "Azure architecture, infrastructure design, and delivery practices.",
  ...
  "cat.kotlin.desc": {
    en: "Kotlin projects, notes, and engineering experiments.",
    es: "Proyectos Kotlin, notas y experimentos de ingeniería.",
  },
  "cat.snippets": { en: "Snippets", es: "Snippets" },
  "cat.snippets.desc": {
    en: "Quick commands and reusable building blocks for day-to-day work.",
    es: "Comandos rápidos y bloques reutilizables para el día a día.",
  },
  "cat.career": { en: "Career", es: "Carrera" },
  "cat.career.desc": {
    en: "Professional updates, retrospectives, and growth notes.",
    es: "Actualizaciones profesionales, retrospectivas y notas de crecimiento.",
  },
  ...
  "archive.description": {
    en: "posts grouped by year, each with clear issue and solution framing.",
    es: "posts agrupados por año, cada uno con problema y solución bien definidos.",
  },
  "archive.searchPlaceholder": {
    en: "Search all posts (title, issue, solution, tags)...",
    es: "Buscar posts (título, problema, solución, tags)...",
  },
  ...
  "about.pageDesc": {
    en: "Professional profile, impact statements, and CV summary.",
    es: "Perfil profesional, logros de impacto y resumen del CV.",
  },
  "about.eyebrow": { en: "Profile", es: "Perfil" },
  "about.headline": {
    en: "Linux & Virtualization Engineer with automation-first execution.",
  ...
  "about.infraTitle": {
    en: "Infrastructure lifecycle ownership",
    es: "Gestión del ciclo de vida de infraestructura",
  },
  "about.infraDesc": {
    en: "RHEL migrations, Satellite lifecycle control, patch management, hardening, and HA/DR readiness.",
    es: "Migraciones RHEL, gestión Satellite, parches, bastionado y preparación HA/DR.",
  },
  "about.autoTitle": { en: "Automation discipline", es: "Disciplina de automatización" },
  "about.autoDesc": {
    en: "Ansible orchestration and Git-based change control for repeatable, peer-reviewed, and auditable operations.",
    es: "Orquestación Ansible y control de cambios con Git para operaciones repetibles, revisadas y auditables.",
  },
  ...
  "about.cvDisabled": {
    ...
    es: "El enlace al CV no está disponible temporalmente.",
  },
  ...
  "about.principle1Title": {
    en: "Codify repeatable operations",
    es: "Codificar operaciones repetibles",
  },
  "about.principle1Desc": {
    en: "Every recurring action should move from ad-hoc command execution into tested automation.",
    es: "Toda acción recurrente debe pasar de ejecución manual a automatización probada.",
  },
  "about.principle2Title": {
    en: "State the problem before the tool",
    es: "Plantear el problema antes que la herramienta",
  },
  "about.principle2Desc": {
    en: "Technology choices are justified by incident patterns, constraints, and measurable operational outcomes.",
    es: "Las decisiones tecnológicas se justifican con patrones de incidentes, restricciones y resultados medibles.",
  },
  "about.principle3Title": {
    en: "Keep portfolio content safe",
    es: "Mantener el contenido del portfolio seguro",
  },
  "about.principle3Desc": {
    en: "Write with practical depth while avoiding confidential architecture, identities, or customer-sensitive data.",
    es: "Documentar con profundidad práctica sin exponer arquitectura confidencial ni datos sensibles.",
  },

  /* ── About: Experience entries ── */
  "exp.pbb.title": {
    en: "Linux and Virtualization Engineer · Deutsche Pfandbriefbank AG",
    es: "Ingeniero Linux y Virtualización · Deutsche Pfandbriefbank AG",
  },
  "exp.pbb.subtitle": {
    en: "Full-time · Hybrid · Madrid, Comunidad de Madrid, España",
    es: "Tiempo completo · Híbrido · Madrid, Comunidad de Madrid, España",
  },
  "exp.pbb.period": { en: "Jul 2025 - Present", es: "Jul 2025 - Presente" },
  "exp.pbb.0": {
    en: "Part of the Linux infrastructure team responsible for 300+ RHEL production servers across multiple datacenters under BaFin/ECB regulatory oversight.",
    es: "Parte del equipo de infraestructura Linux responsable de más de 300 servidores RHEL en producción en múltiples datacenters bajo supervisión regulatoria BaFin/ECB.",
  },
  "exp.pbb.1": {
    en: "Designed Ansible + Git automation pipelines for server provisioning, configuration drift remediation, and lifecycle operations.",
    es: "Diseño de pipelines Ansible + Git para aprovisionamiento, corrección de desvíos de configuración y operaciones de ciclo de vida.",
  },
  "exp.pbb.2": {
    en: "Leading phased RHEL 7/8 to RHEL 9 migration across 300+ servers with Satellite-based provisioning and compliance enforcement.",
    es: "Liderazgo de migración RHEL 7/8 → 9 en más de 300 servidores con aprovisionamiento Satellite y cumplimiento normativo.",
  },
  "exp.pbb.3": {
    en: "Deploying and maintaining application stacks across Nginx, Apache, Tomcat, JBoss/WildFly, and PostgreSQL \u2014 SSL/TLS hardening, reverse proxy tuning, and production optimization for banking-critical workloads.",
    es: "Despliegue y mantenimiento de stacks de aplicaciones con Nginx, Apache, Tomcat, JBoss/WildFly y PostgreSQL \u2014 bastionado SSL/TLS, ajuste de proxy inverso y optimizaci\u00f3n en producci\u00f3n para cargas bancarias cr\u00edticas.",
  },
  "exp.pbb.4": {
    en: "Owning end-to-end patching and hardening cycles for 300+ servers aligned to financial-sector security requirements.",
    es: "Gestión integral de parcheo y bastionado de más de 300 servidores alineada con requisitos de seguridad del sector financiero.",
  },
  "exp.pbb.5": {
    en: "Operating Pacemaker-based HA clusters and executing disaster-recovery drills across distributed datacenters.",
    es: "Operación de clústeres HA con Pacemaker y ejecución de simulacros DR en datacenters distribuidos.",
  },
  "exp.pbb.6": {
    en: "Administering VMware vSphere environments for VM provisioning, capacity planning, and platform lifecycle maintenance.",
  ...
  "exp.pbb.8": {
    ...
    es: "Consultoría de infraestructura para equipos de aplicaciones, traduciendo requisitos de negocio en planes de entrega.",
  },
  "exp.sopra1.title": {
    en: "Information Technology Application Specialist - Linux System Administrator · Sopra Steria",
    es: "Especialista en Aplicaciones TI - Administrador de Sistemas Linux · Sopra Steria",
  },
  "exp.sopra1.subtitle": {
    en: "Full-time · Hybrid · Madrid, Community of Madrid, Spain",
    es: "Tiempo completo · Híbrido · Madrid, Comunidad de Madrid, España",
  },
  "exp.sopra1.period": { en: "Nov 2023 - Jul 2025", es: "Nov 2023 - Jul 2025" },
  "exp.sopra1.1": {
    en: "Led a team of 5 technicians managing 100+ Linux and Windows servers for a Norwegian financial client in a fully English-speaking environment.",
    es: "Liderazgo de equipo de 5 técnicos gestionando más de 100 servidores Linux y Windows para un cliente financiero noruego en entorno anglófono.",
  },
  "exp.sopra1.2": {
    en: "Maintained RHEL compliance across 100+ servers using Red Hat Satellite; built Ansible automation reducing deployment time from hours to minutes.",
    es: "Cumplimiento RHEL en más de 100 servidores con Red Hat Satellite; automatización Ansible reduciendo el aprovisionamiento de horas a minutos.",
  },
  "exp.sopra1.3": {
    en: "Managed VMware vSphere and vCenter environments handling VM lifecycle, snapshot management, and capacity optimization.",
    es: "Gestión de entornos VMware vSphere y vCenter: ciclo de vida de VMs, snapshots y optimización de capacidad.",
  },
  "exp.sopra1.4": {
    en: "Resolved incidents and managed change operations in ServiceNow within SLA deadlines with structured escalation documentation.",
    es: "Resolución de incidencias y gestión de cambios en ServiceNow dentro de SLAs con documentación de escalado estructurada.",
  },
  "exp.sopra1.5": {
    en: "Administered Active Directory computer object lifecycle, group policies, and Kerberos integration for Linux servers.",
    es: "Administración del ciclo de vida de objetos AD, políticas de grupo e integración Kerberos para servidores Linux.",
  },
  "exp.sopra2.title": {
    en: "Information Technology Application Specialist · Sopra Steria",
    es: "Especialista en Aplicaciones TI · Sopra Steria",
  },
  "exp.sopra2.subtitle": {
    en: "Full-time · Madrid, Community of Madrid, Spain",
    es: "Tiempo completo · Madrid, Comunidad de Madrid, España",
  },
  "exp.sopra2.period": { en: "Apr 2023 - Jan 2025", es: "Abr 2023 - Ene 2025" },
  "exp.sopra2.1": {
    en: "Delivered advanced technical support across multiple technologies in enterprise production contexts.",
    es: "Soporte técnico avanzado en producción con múltiples tecnologías.",
  },
  "exp.sopra2.2": {
    en: "Contributed to cloud-transition support initiatives and workplace modernization programs.",
    es: "Participación en iniciativas de migración a cloud y modernización del puesto de trabajo.",
  },
  "exp.sopra2.3": {
    en: "Worked across global collaboration environments with structured escalation and resolution flows.",
    es: "Colaboración en equipos globales con flujos de escalado y resolución estructurados.",
  },
  "exp.intern.title": {
    en: "Internship Trainee · Sopra Steria",
    es: "Becario en Prácticas · Sopra Steria",
  },
  "exp.intern.subtitle": {
    en: "Internship · Madrid, Community of Madrid, Spain",
    es: "Prácticas · Madrid, Comunidad de Madrid, España",
  },
  "exp.intern.period": { en: "Apr 2023 - Jun 2023", es: "Abr 2023 - Jun 2023" },
  "exp.intern.1": {
    en: "Built foundations in incident handling, directory services, and enterprise support workflows.",
    es: "Formación en gestión de incidentes, servicios de directorio y flujos de soporte corporativo.",
  },

  /* ── About: Core areas ── */
  "skill.linux": { en: "Linux Platform Engineering", es: "Ingeniería de Plataformas Linux" },
  "skill.linux.desc": {
    en: "RHEL lifecycle management, troubleshooting, kernel/system tuning, and operational reliability practices.",
    es: "Ciclo de vida RHEL, diagnóstico, ajuste de kernel/sistema y prácticas de fiabilidad operativa.",
  },
  "skill.auto": { en: "Automation & Governance", es: "Automatización y Gobernanza" },
  "skill.auto.desc": {
    en: "Ansible playbooks, reusable role design, Git workflows, and evidence-based operational change controls.",
    es: "Playbooks Ansible, roles reutilizables, flujos Git y controles de cambio basados en evidencia.",
  },
  "skill.virt": { en: "Virtualization & Datacenter Ops", es: "Virtualización y Ops de Datacenter" },
  "skill.virt.desc": {
    en: "VMware vSphere administration, server lifecycle tasks, HA awareness, and disaster-recovery execution.",
    es: "Administración VMware vSphere, ciclo de vida de servidores, alta disponibilidad y recuperación ante desastres.",
  },
  "skill.mid": { en: "App Platforms & Databases", es: "Plataformas y Bases de Datos" },
  "skill.mid.desc": {
    en: "Nginx, Apache, Tomcat, JBoss/WildFly, PostgreSQL \u2014 application deployment, SSL/TLS, reverse proxy, and production database operations.",
    es: "Nginx, Apache, Tomcat, JBoss/WildFly, PostgreSQL \u2014 despliegue de aplicaciones, SSL/TLS, proxy inverso y operaciones de bases de datos en producci\u00f3n.",
  },
  ...
  "skill.team.desc": {
    en: "Stakeholder management, technical consulting for app owners, and requirement-to-platform translation.",
    es: "Gestión de interlocutores, consultoría técnica para equipos de aplicaciones y traducción de requisitos a plataforma.",
  },
  ...
  "catPage.caseSummary": {
    en: "Each post in this domain is written in case-study format: situation, issue, solution, usage context, and delivery impact.",
    es: "Cada post en este dominio está escrito en formato de caso de estudio: situación, problema, solución, contexto de uso e impacto de entrega.",
  },
  "catPage.noPosts": {
    en: "No posts in this category yet.",
    es: "Sin posts en esta categoría aún.",
  },
  ...
  "boot.hint": {
    en: "Click to skip · Esc to continue instantly",
    es: "Clic para saltar · Esc para continuar",
  },
  ...
  "palette.searchPlaceholder": {
    en: "Search commands... (mode, nav, boot)",
    es: "Buscar comandos… (modo, nav, boot)",
  },
  ...
  "cmd.goCv": { en: "View CV / Resume", es: "Ver CV / Currículum" },
  ...
  "metric.aiModeValue": {
    en: "low-latency edge validation",
    es: "validación edge de baja latencia",
  },
