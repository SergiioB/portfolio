...
export const dictionary: Record<string, Record<Lang, string>> = {
  ...
  'about.coverLetterDesc': { en: 'Professional introduction — who I am, what I work on, and how I approach infrastructure and automation.', es: 'Presentación profesional — quién soy, en qué trabajo y cómo enfoco la infraestructura y la automatización.' },
  'about.coverLetterDisabled': { en: 'Cover letter link is temporarily unavailable.', es: 'El enlace a la carta de presentación no está disponible temporalmente.' },
  ...
  'exp.pbb.3': { en: 'Deploying and maintaining application stacks across Nginx, Apache, Tomcat, JBoss/WildFly, and PostgreSQL \u2014 SSL/TLS hardening, reverse proxy tuning, and production optimization for banking-critical workloads.', es: 'Despliegue y mantenimiento de stacks de aplicaciones con Nginx, Apache, Tomcat, JBoss/WildFly y PostgreSQL \u2014 bastionado SSL/TLS, ajuste de proxy inverso y optimizaci\u00f3n en producci\u00f3n para cargas bancarias cr\u00edticas.' },
  ...
  'skill.mid.desc': { en: 'Nginx, Apache, Tomcat, JBoss/WildFly, PostgreSQL \u2014 application deployment, SSL/TLS, reverse proxy, and production database operations.', es: 'Nginx, Apache, Tomcat, JBoss/WildFly, PostgreSQL \u2014 despliegue de aplicaciones, SSL/TLS, proxy inverso y operaciones de bases de datos en producci\u00f3n.' },
