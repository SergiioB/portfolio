...
export const dictionary: Record<string, Record<Lang, string>> = {
  ...
  'about.cvDesc': { en: 'Detailed CV is available as a PDF with role scope, delivery outcomes, and full technology coverage.', es: 'CV detallado disponible en PDF con alcance del puesto, resultados y cobertura tecnológica.' },
  ...
  'exp.pbb.1': { en: 'Architect automated server deployment and lifecycle workflows with Ansible + Git version control.', es: 'Diseño de despliegues automatizados y flujos de ciclo de vida con Ansible + Git.' },
  'exp.pbb.2': { en: 'Lead RHEL 7/8 to RHEL 9 migration strategy and Satellite-based provisioning and software distribution.', es: 'Liderazgo de migración RHEL 7/8 → 9 y aprovisionamiento con Satellite.' },
  'exp.pbb.3': { en: 'Operate Apache Tomcat and JBoss web environments for high-demand application workloads.', es: 'Operación de entornos Apache Tomcat y JBoss para aplicaciones de alta demanda.' },
  'exp.pbb.4': { en: 'Own end-to-end patching and hardening cycles with compliance-oriented operational controls.', es: 'Gestión integral de parcheo y bastionado con controles orientados a cumplimiento.' },
  'exp.pbb.5': { en: 'Manage HA clusters and participate in DR plan execution/testing across distributed datacenters.', es: 'Gestión de clústeres HA y ejecución de planes DR en datacenters distribuidos.' },
  'exp.pbb.6': { en: 'Drive VMware vSphere administration for provisioning, reconfiguration, and platform maintenance.', es: 'Administración VMware vSphere: aprovisionamiento, reconfiguración y mantenimiento.' },
  'exp.pbb.7': { en: 'Collaborate on GenAI business use cases with Azure AI Foundry and document intelligence pipelines.', es: 'Colaboración en casos GenAI con Azure AI Foundry y pipelines de inteligencia documental.' },
  'exp.pbb.8': { en: 'Act as infrastructure consultant for application owners, translating requirements into delivery plans.', es: 'Consultoría de infraestructura para equipos de aplicaciones, traduciendo requisitos en planes de entrega.' },
  ...
  'exp.sopra1.1': { en: 'Handled incidents, service requests, and change operations in ITSM-governed environments.', es: 'Resolución de incidencias, solicitudes de servicio y operaciones de cambio bajo ITSM.' },
  'exp.sopra1.2': { en: 'Supported Linux/Windows application platforms with strong troubleshooting and SLA execution.', es: 'Soporte de plataformas Linux/Windows con diagnóstico avanzado y cumplimiento de SLAs.' },
  'exp.sopra1.3': { en: 'Administered Active Directory connected workflows and operational support for enterprise users.', es: 'Administración de flujos Active Directory y soporte operativo a usuarios corporativos.' },
