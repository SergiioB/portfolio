...
![Troubleshooting 'su' Authentication: The PAM system-auth Pitfall supporting diagram](/images/diagrams/post-framework/infrastructure-flow.svg)

This visual summarizes the implementation flow and control points for **Troubleshooting 'su' Authentication: The PAM system-auth Pitfall**.
...
- Treated **linux** and **pam** as the main risk vectors during implementation.
