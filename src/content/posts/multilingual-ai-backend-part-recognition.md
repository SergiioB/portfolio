...
This allows the backend to cross-match any incoming text against all known variations, identifying the _canonical_ part ID (`SPARK_PLUGS`) regardless of the input language.
