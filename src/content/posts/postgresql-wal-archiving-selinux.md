...
_Note: The `test -f` command ensures we don't accidentally overwrite an existing archive file._
...
_Note: This command only updates the SELinux policy database; it does not change the files on disk yet._
